            ...
            <div className="row">
                ...
                <div className="col-lg-5 col-md-12 mb-3">
                    <div className="col-12 mb-3">
                        <div className="img-large border" style="background-image: url('images/image-1.jpg')"></div>
                    </div>
                    <div className="col-12">
                        <div className="row">
                            <div className="col-sm-2 col-3">
                                <div className="img-small border" style="background-image: url('images/image-1.jpg')" data-src="images/image-1.jpg"></div>
                            </div>
                            <div className="col-sm-2 col-3">
                                <div className="img-small border" style="background-image: url('images/image-2.jpg')" data-src="images/image-2.jpg"></div>
                            </div>
                            <div className="col-sm-2 col-3">
                                <div className="img-small border" style="background-image: url('images/image-3.jpg')" data-src="images/image-3.jpg"></div>
                            </div>
                            <div className="col-sm-2 col-3">
                                <div className="img-small border" style="background-image: url('images/image-4.jpg')" data-src="images/image-4.jpg"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-5 col-md-9 col-sm-3 col-5 mx-auto mt-3">
                                <div className="form-group">
                                    ...
                                    <input type="number" id="qty" min="1" value="1" className="form-control" />
                                </div>
                            </div>
